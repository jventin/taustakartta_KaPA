    ...
    <UserStyle>
      ...
      <FeatureTypeStyle>    
        <Rule>
          ...
          <!--MinScaleDenominator>5000</MinScaleDenominator-->
          <!--MaxScaleDenominator>10000</MaxScaleDenominator--> 
          <PolygonSymbolizer uom="http://www.opengeospatial.org/se/units/metre">  <!-- Phko 100 40 0 26 varilla * 50 % -->
            <Fill>
              <GraphicFill>
                <Graphic>
                  <ExternalGraphic>
...
<!-- allas reunaviiva kohdeluokka 44300 ja kohderyhma 27 on rakennuksen reunaviiva tasolla -->        
  ...
  <NamedLayer> <!-- mtk:tieviiva  --> <!-- tunnelissa ja pinnalla olevat -->
    ...
    <UserStyle>
      ...
      <FeatureTypeStyle> <!-- Tiet, kaytossa (valmiusaste 0), pinnalla (tasosijainti 0 & -1) olevat -->
        <Rule>
          <Name>12312</Name>
  ...
  <NamedLayer> <!-- mtk:rautatie  --> <!-- tunnelissa ja pinnalla olevat rautatiet ja metrot -->
    ...
    <UserStyle>
      ...
      <FeatureTypeStyle> <!-- pinnalla (tasosijainti -1 & 0) kaytossa (valmiusaste 0) -->
        <Rule>
          <Name>14111</Name>
  ...
  <NamedLayer> <!-- mtk:tieviiva --> <!-- sillalla olevat tiet -->
    ...
    <UserStyle>
      ...
      <FeatureTypeStyle> <!-- tiet sillalla, tasosijainti 1,2,3 -->
        <Rule>
          <Name>12132</Name>
  ...
  <NamedLayer> <!-- mtk:rautatie --> <!-- sillalla olevat rautatiet ja metrot-->
    <Name>mtk:rautatie</Name>
    <UserStyle>
      <Title>mtk:rautatie</Title>
      <Abstract>sld</Abstract>
